			...
			if (isShowImg == false) {
				...
				if ($(".faceDiv").children().length == 0) {
					for (var i = 0; i < ImgIputHandler.facePath.length; i++) {
						$(".faceDiv").append("<img title=\"" + ImgIputHandler.facePath[i].faceName + "\" src=\"/FS/Public/front/student/images/face/" + ImgIputHandler.facePath[i].facePath + "\" />");
					}
					$(".faceDiv>img").click(function() {
						isShowImg = false;
						// ImgIputHandler.insertAtCursor($(".Input_text")[0], "[" + $(this).attr("title") + "]");
						ImgIputHandler.insert($(".Input_text")[0], $(this)[0]);
					});
				}
			} else {
				isShowImg = false;
