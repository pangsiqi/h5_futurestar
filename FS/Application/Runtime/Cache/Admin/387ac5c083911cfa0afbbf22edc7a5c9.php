    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-2 ">
            <ol class="breadcrumb">
                ...
                <li><a href="#">作业管理</a></li>
                <li class="active">添加作业信息</li>
            </ol>
            <h3 class="down">添加作业信息<small>Subject Edit</small></h3>
            <div class="list-group form">
                <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" action="/FS/index.php/Admin/S/doAdd">
                <!-- <input type="hidden" name="id" value="<?php echo ($resource["id"]); ?>" /> -->
                    ...
                    <div class="list-group-item">
                        ...
                        <div class="col-sm-10">
                            <input type="input" name="publisher" class="form-control" id="inputEmail3" placeholder="" value="">
                        </div>
                    </div>
                    <div class="list-group-item">
