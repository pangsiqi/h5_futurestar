            ...
            <div class="list-group form">
                ...
                <input type="hidden" name="id" value="<?php echo ($resource["id"]); ?>" />
                    <div class="list-group-item">
                        ...
                        <div class="col-sm-10">
                            <input type="input" name="title" class="form-control" id="inputEmail3" placeholder="" value="<?php echo ($resource["title"]); ?>">
                        </div>
                    </div>
                    <div class="list-group-item">
                    ...
                    <div class="list-group-item">
                        ...
                        <div class="col-sm-10">
                            <input type="input" name="author" class="form-control" id="inputEmail3" placeholder="" value="<?php echo ($resource["author"]); ?>">
                        </div>
                    </div>
                    <div class="list-group-item">
                    ...
                    <div class="list-group-item">
                        ...
                        <div class="col-sm-10">
                            <textarea id="editor_id" name="summary" style="width:90%;height:300px;">
                                <?php echo ($resource["summary"]); ?></textarea>
                        </div>
                    </div>
                    <div class="list-group-item">
