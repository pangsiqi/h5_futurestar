...
<body>
    ...
    <div class="col-md-12 col-lg-8" id="nav">
        <ul>
            ...
            <li><a href="/FS/index.php/Home/Student/studycontent"><img src="<?php echo ($current["thumb"]); ?>" class="nav-img img-circle"/></a>
                <!-- <ul>
                 <li><a href="#">个人信息</a></li>
                 <li><a href="#">上传</a></li>
                 <li><a href="#">退出</a></li>
                    ...
                    <div id="rightcontent">
                        ...
                        <div id="studycontent">
                            <?php if(is_array($courses)): $i = 0; $__LIST__ = $courses;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$course): $mod = ($i % 2 );++$i;?><div id="1">
                                ...
                                <HR width="100%" color=#987cb9 SIZE=8 style="margin-top：9px;margin-buttom:9px;"/><?php endforeach; endif; else: echo "" ;endif; ?>
