...
<head>
    ...
    <!--新添加-->
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 800px) and (max-device-width: 1100px)" href="/FS/Public/front/student/css/classspace1024.css" />
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1240px) and (max-device-width: 2000px)" href="/FS/Public/front/student/css/classspace.css" />
...
<body>
    ...
    <div class="col-md-8" id="nav">
        <ul>
            ...
            <li>
                <a href="/FS/index.php/Home/Student/personcenter"><img src="<?php echo ($current["thumb"]); ?>" class="nav-img img-circle" /></a>
                <!-- <ul>
                 <li><a href="#">个人信息</a></li>
                 <li><a href="#">上传</a></li>
                 <li><a href="#">退出</a></li>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-md-4 column" id="left">
                            ...
                            <div id="top">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="person"><img src="<?php echo ($current["thumb"]); ?>" class="current-user-thumb" />
                                    <ul>
                                        <li><h1><?php echo ($current["realname"]); ?></h1></li>
                                        <li><h2><?php echo ($current["grade"]); ?></h2></li>
                                ...
                                <div id="giftpic">
                                    <div class="col-md-4 column">
                                        ...
                                        <a href="#" style="padding-left: 25px">0</a>
                                    </div>
                                    <div class="col-md-4 column">
                                    ...
                                    <div class="col-md-4 column">
                                        <img src="/FS/Public/front/student/images/yellowstar.png" />
                                        <a href="#" style="padding-left: 23px"><?php echo ($current["starnum"]); ?></a>
                                    </div>
                                </div>
                            </div>
                            <div id="buttom">
                                <p>同班同学</p>
                                <HR width="100%" color=#bbbbbb SIZE=8 />
                                <div style="text-align: center" id="buttom_img">
                                    <div class="col-md-4 column">
