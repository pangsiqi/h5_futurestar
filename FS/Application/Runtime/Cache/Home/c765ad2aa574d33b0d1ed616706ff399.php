                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-md-4 column" id="left">
                            <h1 style="font-weight: bold"><?php echo ($current["grade"]); ?></h1>
                            <div id="top">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><img src="<?php echo ($current["thumb"]); ?>" class="current-user-thumb img-circle" /></div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <ul class="clearfix">
                                        <li>
                                            <p><a href="#"><?php echo ($current["realname"]); ?></a></p>
                                        </li>
                                        <li>
                                            <p><img src="/FS/Public/front/student/images/yellowstar.png" /><span><a href="#"><?php echo ($current["starnum"]); ?></a></span></p>
                                        </li>
                                        <!--<br/>
