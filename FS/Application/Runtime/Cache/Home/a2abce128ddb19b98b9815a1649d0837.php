    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <div id="nav2">
                    ...
                    <div id="chinese"><a href="chinese.html">语文印象</a></div>
                    <div  id="math"><a href="math.html">数学印象</a></div >
                    <div  id="english"><a href="english.html">英语印象</a></div >
                    <div  id="walk"><a href="walktolisten.html">随身听</a></div >
                    <div  id="garden"><a href="classgarden.html">课外乐园</a></div >
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-8" id="rightcontent">
                        <div id="title">
                                    <ul>
                                        <a href="index.html">首页</a> / <a href="chinese.html">学习中心</a> / <a href="#">语文印象</a>
                                    </ul>
                        </div>
                        ...
                        <div id="studycontent">
                            <div id="1">
                                ...
                                <div class="col-md-8 column" style="margin-left: 100px;">
                                    <ul>
                                        <li>课程内容：<a href="#">第一单元&nbsp;看图识字</a></li>

                                        <li>课程描述：这门课程主要讲的是幼儿园语文的第一单元的课程课程，课程的内容是内容内容内容内容内容内容内容内容</li>
                                        <li>开始时间：2016年11月4日</li>
                                        <li>截止时间：2016年11月4日</li><li>完成情况：未完成</li>
                                        <li style="float: right; margin-top:-51px;margin-right: 11px;" ><a href="studycontent.html"><button type="button" class="btn btn-info">开始作业</button></a></li>
