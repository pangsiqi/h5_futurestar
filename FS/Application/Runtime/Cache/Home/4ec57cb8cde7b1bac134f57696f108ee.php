            ...
            <div class="col-md-12 column" id="content_h">
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <ol>
                        ...
                        <li>姓名：&nbsp;
                            <input id="tea_name2" type="text" name="realname" value="<?php echo ($stu["realname"]); ?>" />
                        </li>
                    ...
                    <ul class="dropdown-menu" id="navbarDrop6">
                        ...
                        <li><a href="#two" >女</a></li>
                            ...
                            <select name="sex" id="" value="<?php echo ($stu["sex"]); ?>">
                                <option value="男">男</option>
                                <option value="女">女</option>
                            </select>
                        </li>
                        <li>出生日期：
                            <input size="16" type="text" name="birthday" value="<?php echo ($stu["birthday"]); ?>" readonly class="form_datetime" id="bir">
                        ...
                        <li>学校：<input id="tea_name2" type="text" name="school" value="<?php echo ($stu["school"]); ?>" /></li>
                        <li>年级：<input id="tea_name2" type="text" name="grade" value="<?php echo ($stu["grade"]); ?>" /></li>
                        <li id="save">
