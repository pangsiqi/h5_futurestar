...
<head>
    ...
    <link rel="stylesheet" href="/FS/Public/front/teacher/css/workpaper.css">
                ...
                <div class="row clearfix">
                    <div class="col-md-12 column"  id="h4">
                       <ul id="check">
                           ...
                           <li><a href="#">0/3</a></li>
                           <a href="/FS/index.php/Home/Teacher/checkhomework.html"><input class="check" name="check" value="检查作业" /></a>
                       </ul>
                    </div>
                </div>
            </div>
