        ...
        <div class="col-md-6 column" id="right1">
            ...
            <div class="row clearfix">
                <div class="col-md-12 column" id="task1">
                    ...
                    <?php if(is_array($homework)): $i = 0; $__LIST__ = $homework;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="row">
                            <div class="col-md-4 column">
                                <ul id="task1_n">
                                    <li><p><?php echo ($data["username"]); ?></p></li>
                                </ul>
                            </div>
                            <div class="col-md-4 column">
                                <ul class="task1_s">
                                    <li><p id="task1_s"><?php echo ($data["subject"]); ?></p></li>
                                </ul>
                            </div>
                            <div class="col-md-4 column">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12 column" id="dynamic">
                    <a href="/FS/index.php/Home/Teacher/guestbook.html">
        ...
        <div class="col-md-3 column" id="homework">
            ...
            <div class="row clearfix">
                <div class="col-md-6 column">
                    <img alt="45x45" src="/FS/Public/front/teacher/images/1-1.png" />
                    <p>名字</p>
                </div>
                <div class="col-md-6 column">
                    <img alt="45x45" src="/FS/Public/front/teacher/images/1-1.png" />
