...
<head>
    ...
    <!-- <link href="/FS_siqi/Public/front/student/css/parentspace.css" rel="stylesheet" type="text/css" /> -->


    <!--新添加-->
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 800px) and (max-device-width: 1100px)" href="/FS_siqi/Public/front/student/css/parentspace1024.css" />
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1240px) and (max-device-width: 2000px)" href="/FS_siqi/Public/front/student/css/parentspace.css" />
...
<body>
    ...
    <div class="container">
        <div class="row clearfix">
            <div class="col-md-12 column">
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div id="parenthead"><img src="/FS_siqi/Public/front/student/images/parenthead.png" class="img-circle" /></div>
                        <div id="name">
                            <h1><?php echo ($current["realname"]); ?></h1> 学号：<?php echo ($current["id"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span>学校：<?php echo ($current["school"]); ?></span>
                        </div>
                        <p>与老师交流</p>
                        <form method="post" action="/FS_siqi/index.php/Home/Student/addMessage">
                            <div id="send">
                                <div id="seriesline">
                                ...
                                <div id="left">
                                    <span class="imgBtn"><img src="/FS_siqi/Public/front/student/images/face.jpg" />&nbsp;&nbsp;表情</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/FS_siqi/Public/front/student/images/pic.jpg" />&nbsp;&nbsp;图片</span><span class="right"><input type="submit" class="btn btn-warning send-btn" value="发送"></span>
                                </div>
                        ...
                        <div id="message">
                            <div id="jp-container" class="jp-container">
                                <?php if(is_array($message)): $i = 0; $__LIST__ = $message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mr): $mod = ($i % 2 );++$i;?><div class="talk_recordboxme">
                                        <div class="user"><img src="/FS_siqi/Public/front/student/images/15.jpg" /></div>
                                    ...
                                    <div class="talk_recordbox">
                                        <div class="user"><img src="/FS_siqi/Public/front/student/images/14.jpg" /></div>
                                        <div class="talk_recordtextbg">&nbsp;</div>
                                        <div class="talk_recordtext">
                        ...
                        <div id="spect">
                            <p>&nbsp;家长完成任务宝宝拿奖励啦~~~</p>
                            <p><img src="/FS_siqi/Public/front/student/images/heartspect.png" /></p>
                        </div>
                        <!--二维码模块-->
                        <div id="write">
                            <p>详情扫描下方二维码填写心愿~~</p>
                            <img src="/FS_siqi/Public/front/student/images/code.jpg" />
                        </div>
                    </div>
                </div>
                <!--chatwindow的css样式-->
    ...
    <script type="text/javascript" src="/FS_siqi/Public/front/student/js/jquery-1.2.6.min.js"></script>
    <script type="text/javascript" src="/FS_siqi/Public/front/student/js/face.js"></script>
