...
<div class="col-md-8 column" id="nav">
    <ul>
        ...
        <li id="email"><a href="parentspace.html"><img src="/FS/Public/front/student/images/email.png" /></a></li>
        <li id="person"><a href="personcenter.html"/> <img src="/FS/Public/front/student/images/headpic.jpg" class="img-circle" /></a></li>
        <!-- <ul>
             <li><a href="#">个人信息</a></li>
             <li><a href="#">上传</a></li>
             <li><a href="#">退出</a></li>
        ...
        <div class="col-md-12 column">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-4 column" id="left1024">
                    ...
                    <ul id="name">
                        <li><img src="/FS/Public/front/student/images/hands.png" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;李小明</li>
                        <li><img src="/FS/Public/front/student/images/hands.png" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;王华</li>
                        <li><img src="/FS/Public/front/student/images/hands.png" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;张丽丽</li>
                    </ul>
                ...
                <div class="col-md-8 column">
                    <div class="row clearfix" id="right_course">
                        <div >
                            <ul>
                                <li><img src="/FS/Public/front/student/images/course.jpg" /></li>
                                <li><a href="studycontent.html"><img src="/FS/Public/front/student/images/start_study.png" /></a></li>
                            </ul>
                    ...
                    <div id="classsky"><a href="classspace.html"><img src="/FS/Public/front/student/images/classsky.png" /></a> </div>
                    <div id="parentspace"><a href="parentspace.html"><img src="/FS/Public/front/student/images/parentspace.png" /></a> </div>
                    <div id="pk"><a href="pk.html"><img src="/FS/Public/front/student/images/pk.png" /></a> </div>
                    <div id="studycenter"><a href="studycenter.html"><img src="/FS/Public/front/student/images/studycenter.png" /></a> </div>
                    <div id="gift"><a href="gift.html"><img src="/FS/Public/front/student/images/gift.png" /></a> </div>
