            ...
            <div class="col-md-12 column">
                <div class="row clearfix">
                    ...
                    <div id="nav2">
                        ...
                        <div id="walk"><a href="/FS_siqi/index.php/Home/Student/chinese.html">随身听</a></div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-8" id="rightcontent">
                            <div id="title">
                                <ul>
                                    <a href="/FS_siqi/index.php/Home/Student/index.html">首页</a> / <a href="/FS_siqi/index.php/Home/Student/chinese.html">学习中心</a> / <a href="/FS_siqi/index.php/Home/Student/#"><?php echo ($course["subject"]); ?></a>
                                </ul>
                            </div>
                            <div id="studycontent">
                                <div id="1">
                                    <div class="col-md-2 column">
                                        <div style=" width: 150px;margin-top: 20px; margin-left: 50px; border:2px rgb(44,183,192) solid; border-radius: 10px;"><img src="/FS_siqi/Public/front/student/images/list_book.jpg" style="border-radius: 10px;" /></div>
                                    </div>
                                ...
                                <div id="2">
                                    <div class="col-md-2 column">
                                        <div style=" width: 150px;margin-top: 15px; margin-left: 50px; border:2px rgb(44,183,192) solid; border-radius: 10px;"><img src="/FS_siqi/Public/front/student/images/list_book.jpg" style="border-radius: 10px;" /></div>
                                    </div>
                                    <div class="col-md-8 column" style="margin-left: 100px;">
                                        <ul>
                                            <li>课程内容：<a href="#"><?php echo ($course["title"]); ?></a></li>
