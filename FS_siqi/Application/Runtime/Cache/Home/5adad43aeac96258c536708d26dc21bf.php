...
<head>
    ...
    <!-- <link href="/FS_siqi/Public/front/student/css/studycontent.css" rel="stylesheet" type="text/css" /> -->
    ...
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 800px) and (max-device-width: 1100px)" href="/FS_siqi/Public/front/student/css/studycontent1024.css" />
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1240px) and (max-device-width: 2000px)" href="/FS_siqi/Public/front/student/css/studycontent.css" />
            ...
            <div class="col-md-12 column">
                ...
                <div class="row clearfix">
                    <div id="rightcontent">
                        ...
                        <div id="studycontent">
                            <div id="video">
                                <embed src="resource/shuxue1.swf"  class="shipin" />
                                <!--/*控制播放和暂停*/-->
                            </div>
                            <HR width="100%" color=#fff SIZE=8 />
                            <div id="play">
                                <!--<img src="/FS_siqi/Public/front/student/images/play.png" />-->
                            </div>
                            <!--推荐内容-->
                            <div id="other">
                                <div>
                                    <a href="#"><img src="/FS_siqi/Public/front/student/images/better_content.png" /></a>
                                </div>
                                <div>
                                    <a href="#"><img src="/FS_siqi/Public/front/student/images/course.jpg" /></a>
                                </div>
                                <div>
                                    <a href="#"><img src="/FS_siqi/Public/front/student/images/course.jpg" /></a>
                                </div>
