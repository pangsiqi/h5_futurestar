...
<head>
    ...
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 800px) and (max-device-width: 1100px)" href="/FS_l/Public/front/teacher/css/index1024.css" />
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1240px) and (max-device-width: 2000px)" href="/FS_l/Public/front/teacher/css/index.css" />
        ...
        <div class="col-md-6 column" id="right1">
            ...
            <div class="row clearfix">
                <div class="col-md-12 column" id="task1">
                    ...
                    <?php if(is_array($homework)): $i = 0; $__LIST__ = $homework;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="row">
                            ...
                            <div class="col-md-4 column">
                                <a href="/FS_l/index.php/Home/Teacher/workpaper.html">
            ...
            <div class="row clearfix">
                ...
                <div id="dynamic">
                    ...
                    <img id="task3_p" src="images/1-3.png" />
                    </a>
                </div>
            </div>
            <div class="row clearfix">
                ...
                <div class="col-md-12 column" id="task4">
                    ...
                    <a href="/FS_l/index.php/Home/Teacher/upload.html">
        ...
        <div class="col-md-3 column" id="homework">
            ...
            <div class="row clearfix">
                <?php if(is_array($stuFinish)): $i = 0; $__LIST__ = $stuFinish;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sf): $mod = ($i % 2 );++$i;?><div class="col-md-6 column">
                        <img alt="<?php echo ($sf["realname"]); ?>" src="<?php echo ($sf["thumb"]); ?>" class="finishstu-thumb" />
