...
<head>
    ...
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 800px) and (max-device-width: 1100px)" href="/FS_l/Public/front/teacher/css/checkhomework1024.css" />
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1240px) and (max-device-width: 2000px)" href="/FS_l/Public/front/teacher/css/checkhomework.css" />
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table ">
                    ...
                    <tr >
                        ...
                        <td>
                            ...
                            <a href="#" data-toggle="modal" data-target="#myModalSee" class="see-commit" id="check_che">查看</a>
                            <a href="#">奖学豆</a>
                        </td>
                    </tr>
                    <tr >
