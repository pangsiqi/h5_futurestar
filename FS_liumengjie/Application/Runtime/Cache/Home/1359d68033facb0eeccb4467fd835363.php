...
<head>
    ...
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 800px) and (max-device-width: 1100px)" href="/FS_l/Public/front/teacher/css/update1024.css" />
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1240px) and (max-device-width: 2000px)" href="/FS_l/Public/front/teacher/css/update.css" />
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <ol>
                        <li>
                            ...
                            <input type="file" name="thumb" id="upfile" onchange="uploadFile()">
                        </li>
