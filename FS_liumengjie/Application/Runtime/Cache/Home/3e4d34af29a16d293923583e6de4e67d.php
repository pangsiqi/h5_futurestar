...
<head>
    ...
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 800px) and (max-device-width: 1100px)" href="/FS_l/Public/front/teacher/css/personCenter1024.css" />
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1240px) and (max-device-width: 2000px)" href="/FS_l/Public/front/teacher/css/personCenter.css" />
    ...
    <div class="row clearfix" id="content">
        ...
        <div class="col-md-7 column" id="content_right">
            <div class="col-md-12 column" id="content_h">
                <ol>
                    <li>
                        <img  class="userthumb" title="<?php echo ($tea["realname"]); ?>" alt="头像" src="<?php echo ($tea["thumb"]); ?>" />
                    </li>
                    ...
                    <li class="mod">
                        <a href="/FS_l/index.php/Home/Teacher/update">
