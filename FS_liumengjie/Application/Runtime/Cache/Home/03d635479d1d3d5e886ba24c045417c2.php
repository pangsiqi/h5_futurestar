...
<head>
    ...
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 800px) and (max-device-width: 1100px)" href="/FS_l/Public/front/teacher/css/workpaper1024.css" />
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1240px) and (max-device-width: 2000px)" href="/FS_l/Public/front/teacher/css/workpaper.css" />
                ...
                <div class="row clearfix">
                    <div class="col-md-12 column"  id="h4">
                       <ul id="check">
                           ...
                           <li><a href="#">0/3</a></li>
                           <a href="/FS_l/index.php/Home/Teacher/checkhomework.html"><input class="check" name="check" value="检查作业" /></a>
                       </ul>
                    </div>
                </div>
            </div>
