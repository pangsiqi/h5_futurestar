            ...
            <div class="lop-inner">
                ...
                <div class="lop-content">
                    ...
                    <div class="JS-defaultMode">
                        <form method="post" action="/FS_l/index.php/Home/Index/addTeaTel">
                    ...
                    <div class="lop-tab tabLeft">
                        <ul>
                            <li class="JS-selectStudent-main" onclick="location.href='/FS_l/index.php/Home/Index/resStu'">
                                <div class="image"></div>
                                <div class="side">我是学生</div>
                            </li>
                            <li class="JS-selectTeacher-main tea active" onclick="location.href='/FS_l/index.php/Home/Index/resTeacher'">
