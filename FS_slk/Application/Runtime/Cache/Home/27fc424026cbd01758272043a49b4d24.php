...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 800px) and (max-device-width: 1100px)" href="/FS/Public/front/teacher/css/myclass1024.css" />
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1240px) and (max-device-width: 2000px)" href="/FS/Public/front/teacher/css/myclass.css" />
        ...
        <div class="col-md-7 column" id="content_h">
            <div class="row clearfix">
                <div class="col-md-12 column" id="right1">
                    <h4 id="title"><?php echo ($tea["grade"]); ?></h4>
                </div>
            </div>
            <div class="row clearfix">
                <div class="col-md-12 column" id="right2">
                    <a hefr="#" id="button">
                        <button class="check">学生情况</button> 
                    </a>
                </div>
                <div class="row clearfix">
                    <?php if(is_array($student)): $i = 0; $__LIST__ = $student;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$stu): $mod = ($i % 2 );++$i;?><div class="col-md-3 column">
                            <div class="name">
                                <img alt="<?php echo ($stu["realname"]); ?>" src="<?php echo ($stu["thumb"]); ?>" width="110px" height="110px" class="picture" />
                                <a href="/FS/index.php/Home/Teacher/studentinfo/id/<?php echo ($stu["id"]); ?>">
