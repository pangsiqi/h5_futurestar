        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                ...
                <div id="nav2">
                    ...
                    <div id="english">
                        <a href="/FS/index.php/Home/Student/english.html"></a>
                    </div>
                    <div id="walk">
                        <a href="/FS/index.php/Home/Student/walktolisten.html"></a>
                    </div>
                    <div id="garden">
                        <a href="/FS/index.php/Home/Student/classgarden.html"></a>
                    </div>
                </div>
                <!--右侧内容-->
                <div class="row clearfix">
